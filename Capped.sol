pragma solidity ^0.6.6;
 ...
 contract Capped is ERCI20  {
     ...
     function _mint(address account, uint256 _amount) public {
         require(account != address(0), "ERC20: mint to the zero address"); 
         
        _totalSupply = _totalSupply.add(_amount);
        
        require(_totalSupply <= 500, "ERROR"); // this require will check the minting amount plus the 
